...
function getTemplateHeaders(role: AppRole): string[] {
  if (role === "SERVED_MEMBER") {
    return ["الاسم", "الموبايل", "تاريخ الميلاد", "هاتف الأب", "هاتف الأم", "العنوان", "الصف"]
  }
  return ["الاسم", "الموبايل", "تاريخ الميلاد"]
}

function getTemplateSampleRows(role: AppRole): (string | number)[][] {
  if (role === "SERVED_MEMBER") {
    return [
      ["يوسف ناصر", "01012345678", "2000-05-15", "01098765432", "01087654321", "القاهرة", "الصف الأول"],
      ["مرى بخيت", "01123456789", "", "", "", "", "الصف الثاني"],
    ]
  }
  return [
    ["مرقس عادل", "01011112222", "1990-03-20"],
    ["تيرسأ حنا", "01233334444", ""],
  ]
}
